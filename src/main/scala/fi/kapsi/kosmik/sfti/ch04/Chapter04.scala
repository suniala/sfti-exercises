...
object Chapter04 {
  /**
    ...
    */
  def ex01(gizmos: Map[String, Double]): Map[String, Double] =
  ...
  /**
    ...
    */
  def ex02(input: InputStream): Map[String, Int] = {
  ...
  /**
    ...
    */
  def ex03(input: InputStream): Map[String, Int] = {
  ...
  /**
    ...
    */
  def ex04(input: InputStream): SortedMap[String, Int] = {
  ...
  /**
    ...
    * Scala API.
    */
  def ex05(input: InputStream): mutable.Map[String, Int] = {
    import scala.collection.JavaConverters._
  ...
  /**
    ...
    * in insertion order.
    */
  def ex06(entries: List[(String, Int)]): mutable.LinkedHashMap[String, Int] = {
  ...
  /**
    ...
    */
  def ex08_minmax(values: Array[Int]): (Int, Int) = (values.min, values.max)
  ...
  /**
    ...
    */
  def ex09_lteqgt(values: Array[Int], v: Int): (Int, Int, Int) = {
  ...
  /**
    ...
    */
  def ex10(a: String, b: String): immutable.IndexedSeq[(Char, Char)] = a.zip(b)
}
