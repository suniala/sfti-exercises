...
class Chapter10Spec extends FunSpec with Matchers with MockFactory {
  describe("Exercise 01") {
    import fi.kapsi.kosmik.sfti.Chapter10.Ex01._
  ...
  describe("Exercise 02") {
    import fi.kapsi.kosmik.sfti.Chapter10.Ex02._
  ...
  describe("Exercise 04") {
    import fi.kapsi.kosmik.sfti.Chapter10.Ex04._
  ...
  describe("Exercise 05") {
    ...
    import fi.kapsi.kosmik.sfti.Chapter10.Ex05._
  ...
  describe("Exercise 09") {
    import fi.kapsi.kosmik.sfti.Chapter10.Ex09._
  ...
  describe("Exercise 11") {
    import fi.kapsi.kosmik.sfti.Chapter10.Ex11._
