...
class Chapter08Spec extends FunSpec with Matchers {
  describe("Exercise 01") {
    import fi.kapsi.kosmik.sfti.Chapter08.Ex01._
  ...
  describe("Exercise 02") {
    it("should add transaction fee after third transaction in month") {
      import fi.kapsi.kosmik.sfti.Chapter08.Ex02._
  ...
  describe("Exercise 04") {
    import fi.kapsi.kosmik.sfti.Chapter08.Ex04._
  ...
  describe("Exercise 05") {
    import fi.kapsi.kosmik.sfti.Chapter08.Ex05._
  ...
  describe("Exercise 06") {
    import fi.kapsi.kosmik.sfti.Chapter08.Ex06._
  ...
  describe("Exercise 07") {
    import fi.kapsi.kosmik.sfti.Chapter08.Ex07._
  ...
  describe("Exercise 09") {
    import fi.kapsi.kosmik.sfti.Chapter08.Ex09._
