...
class Chapter11Spec extends FunSpec with Matchers {
  describe("Exercise 03") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex03._
  ...
  describe("Exercise 04") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex04._
  ...
  describe("Exercise 05") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex05._
  ...
  describe("Exercise 06") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex06.{Cat, Hello}

    def expected(name: String): String =
      scala.io.Source.fromInputStream(getClass.getResourceAsStream(name + ".txt"))
        .getLines().mkString("\n")
  ...
  describe("Exercise 07") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex07._
  ...
  describe("Exercise 08") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex08._
  ...
  describe("Exercise 09") {
    ...
    import fi.kapsi.kosmik.sfti.Chapter11.Ex09._
  ...
  describe("Exercise 10") {
    ...
    import fi.kapsi.kosmik.sfti.Chapter11.Ex10._
  ...
  describe("Exercise 11") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex11._
  ...
  describe("Exercise 12") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex12._
  ...
  describe("Exercise 13") {
    import fi.kapsi.kosmik.sfti.Chapter11.Ex13._
